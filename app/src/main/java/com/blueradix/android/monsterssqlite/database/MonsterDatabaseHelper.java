package com.blueradix.android.monsterssqlite.database;
...
public class MonsterDatabaseHelper extends SQLiteOpenHelper {
     ...
     *              otherwise -1
     */
    public Long insert(String name, String description, Long scariness) {
     ...
     */
    public boolean update(Long id, String name, String description, Long scariness) {
        SQLiteDatabase db = this.getWritableDatabase();
